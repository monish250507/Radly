...
If you discover a security vulnerability in PaperBlast, please report it via GitHub Security Advisories. Do not open a public issue.

## Threat Model
PaperBlast analyzes potentially untrusted code and manuscripts. 
